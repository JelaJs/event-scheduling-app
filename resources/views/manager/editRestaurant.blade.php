...
@section('content')
<form class="bg-white shadow-md rounded-lg p-6 space-y-6 max-w-lg my-3" method="POST" action="{{ route('manager.restaurant.update', $restaurant->id) }}" enctype="multipart/form-data">
    @if ($errors->any())
